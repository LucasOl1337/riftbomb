import*as p from"react";var k=`attribute vec2 a_pos;
void main(){ gl_Position = vec4(a_pos, 0.0, 1.0); }`,R=`#extension GL_OES_standard_derivatives : enable
...
}`;var h=["noise","flow","cellular","gyroid","truchet","interfere","kaleido","lines","grid","golden","smoke","crystal","honeycomb","bloom","sweep"];var x=["aurora","sunset","ocean","dusk","ember","mint","iris","chrome"],m=[[[.035,.063,.16],[.05,.42,.45],[.27,.78,.55],[.96,.74,.84]],[[.1,.045,.18],[.52,.12,.42],[.93,.4,.25],[.99,.84,.52]],[[.02,.05,.14],[.04,.29,.5],[.18,.66,.76],[.78,.96,.91]],[[.085,.078,.2],[.35,.22,.55],[.7,.49,.77],[.97,.8,.87]],[[.035,.02,.02],[.49,.1,.1],[.9,.45,.13],[.98,.9,.72]],[[.03,.13,.11],[.12,.43,.35],[.45,.83,.67],[.93,.99,.95]],[[.04,.03,.1],[.27,.14,.62],[.4,.62,.95],[.92,.86,.99]]],y=["square","hex","ascii","dither","glitch"],w=["none","glass","metal","sand","liquid","molten"],E=["normal","multiply","screen","add","difference","overlay"],M=[{label:"BOREALIS",field:0,p:[.4,2,3.5,.03,1,10,0,0,30,0,0,1]},{label:"AFTERGLOW",field:1,p:[.5,1.6,4,.03,1,10,0,1,21,0,0,1]},{label:"TIDE",field:1,p:[.5,1.5,5,.03,1,10,0,2,48,0,0,1]},{label:"TWILIGHT",field:0,p:[.35,2.3,3,.03,1,10,0,3,12,0,0,1]},{label:"MAGMA",field:0,p:[.45,1.8,4.5,.03,1,10,0,4,52,0,0,1]},{label:"MERIDIAN",field:1,p:[.5,1.6,5,.03,1,10,0,5,66,0,0,1]},{label:"NEBULA",field:2,p:[.4,1.9,7,.03,1,8,0,6,40,0,0,1]},{label:"PLASMA",field:1,p:[.7,1.2,8,.04,1,10,0,0,71,0,0,1]},{label:"VELVET",field:0,p:[.3,2.6,2,.02,1,10,0,3,18,0,0,1]},{label:"CORAL",field:2,p:[.45,1.8,7,.03,1,10,0,1,33,0,0,1]},{label:"GLACIER",field:0,p:[.4,2.2,3,.03,1,10,0,2,25,0,0,1]},{label:"ONYX",field:2,p:[.4,1.9,8,.03,1,8,0,7,60,0,0,1]},{label:"WEAVE",field:3,p:[.4,1.6,5,.03,1,10,0,5,40,0,0,1]},{label:"CIRCUIT",field:4,p:[.3,2,4,.02,1,10,0,7,22,0,0,1]},{label:"RIPPLE",field:5,p:[.5,1.4,5,.03,1,10,0,2,30,0,0,1]},{label:"MANDALA",field:6,p:[.35,1.5,6,.03,1,10,0,6,55,0,0,1]},{label:"STRATA",field:7,p:[.3,1.6,3,.02,1,10,0,3,28,0,0,1]},{label:"MESH",field:8,p:[.3,1.8,4,.02,1,10,0,5,33,0,0,1]},{label:"SUNFLOWER",field:9,p:[.3,1.4,5,.02,1,10,0,4,44,0,0,1]},{label:"RIBBON",field:3,p:[.3,1.55,4.8,.02,4,9,1,2,28,0,0,.5625]},{label:"VORTEX",field:6,p:[.34,1.18,7.2,.02,6,10,1,5,61,0,0,.5625]},{label:"ABYSS",field:0,p:[.22,2.25,7.6,.03,5,8,1,2,87,0,0,.5625]},{label:"NOVA",field:5,p:[.32,1.18,6.4,.02,4,7,1,7,52,0,0,.5625]},{label:"PIXELBEAM",field:1,screen:3,thresh:.46,p:[.45,1.6,4,0,7,10,0,4,40,0,0,1]},{label:"SMOKE",field:10,cols:["#040414","#0a3a7a","#0484fc","#c2dbdc"],p:[.38,1.3,3,.015,1,10,0,0,30,0,0,1]},{label:"GILDED",field:0,material:5,cols:["#0a0602","#6b3a05","#e8940f","#ffdf8a"],p:[.28,.6,3.5,.015,1,10,0,0,47,0,0,1]},{label:"MERCURY",field:0,material:5,cols:["#020204","#1c1a2e","#5a5670","#e8e0f2"],p:[.28,.7,4,.015,1,10,0,0,61,0,0,1]},{label:"BLOOM",field:13,cols:["#c2b830","#e04a12","#e8489a","#f2ead8"],p:[.35,.95,2.5,.14,1,10,0,0,24,0,0,1]},{label:"HORIZON",field:14,cols:["#0d0b2e","#552a8a","#f27059","#ffd9a0"],p:[.3,1.2,3.2,.05,1,10,0,0,33,0,0,1]}];var F=3840*2160;function S(a){return a=String(a).replace("#",""),a.length===3&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]),[parseInt(a.substr(0,2),16)/255,parseInt(a.substr(2,2),16)/255,parseInt(a.substr(4,2),16)/255]}function g(a){return Math.round(a[0]*255)*65536+Math.round(a[1]*255)*256+Math.round(a[2]*255)}function d(a,e){return typeof e=="number"?e>=0&&e<a.length?Math.round(e):-1:a.indexOf(String(e).toLowerCase())}var N={field:0,field2:0,blend:0,layerMix:0,screen:0,material:0,sym:0,pal:0,cols:null,speed:.6,zoom:1.6,warp:4.5,grain:.06,pixel:1,dot:10,dots:0,thresh:.5,seed:null};function P(a){let e=" .:-=+*#%@",n=a.createElement("canvas");n.width=28*e.length,n.height=28;let o=n.getContext("2d");o.fillStyle="#000",o.fillRect(0,0,n.width,n.height),o.fillStyle="#fff",o.font="bold "+Math.round(28*.82)+"px ui-monospace, Menlo, Consolas, monospace",o.textAlign="center",o.textBaseline="middle";for(let i=0;i<e.length;i++)o.fillText(e.charAt(i),i*28+28/2,28/2+1);return n}var _=class{constructor(e,t={}){if(!e||e.nodeType!==1)throw new Error("fluid-core: container must be an element");this.container=e,this.doc=e.ownerDocument,this.state=Object.assign({},N),this._applyParams(t),this.state.seed==null&&(this.state.seed=3+Math.random()*89),this.canvas=this.doc.createElement("canvas"),this.canvas.style.cssText="display:block;width:100%;height:100%;",e.appendChild(this.canvas),this.t=0,this._raf=null,this._last=0,this._destroyed=!1,this._visible=!0,this._needsPaint=!0;let n=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion: reduce)").matches&&t.respectReducedMotion!==!1;this._playing=t.paused?!1:!n,this._initGL(),this._ro=typeof ResizeObserver=="function"?new ResizeObserver(()=>{this._needsPaint=!0,this._kick()}):null,this._ro&&this._ro.observe(e),this._io=typeof IntersectionObserver=="function"?new IntersectionObserver(o=>{this._visible=!!(o[0]&&o[0].isIntersecting),this._kick()}):null,this._io&&this._io.observe(e),this._onVis=()=>this._kick(),this.doc.addEventListener("visibilitychange",this._onVis),this._onLost=o=>{o.preventDefault(),this._stopLoop()},this._onRestored=()=>{this._initGL(),this._needsPaint=!0,this._kick()},this.canvas.addEventListener("webglcontextlost",this._onLost),this.canvas.addEventListener("webglcontextrestored",this._onRestored),this._kick()}set(e){return this._applyParams(e),this._needsPaint=!0,this._kick(),this}play(){return this._playing=!0,this._kick(),this}pause(){return this._playing=!1,this._kick(),this}get playing(){return this._playing}shareUrl(e="https://fluid.krackeddevs.com/",t=!1){let n=this.state,o=this.canvas.clientHeight>0?this.canvas.clientWidth/this.canvas.clientHeight:1,i=[+n.speed.toFixed(2),+n.zoom.toFixed(2),+n.warp.toFixed(1),+n.grain.toFixed(3),Math.round(n.pixel),Math.round(n.dot),n.dots?1:0,n.pal,+n.seed.toFixed(2),.8,.85,+o.toFixed(4),0,t?1:0,n.field,n.screen,0,0,Math.round(n.sym||0),0];n.pal===8&&i.push(g(n.cols[0]),g(n.cols[1]),g(n.cols[2]),g(n.cols[3]));let r=+(n.thresh-.5).toFixed(2);if(r!==0){for(;i.length<24;)i.push(0);i.push(r)}if((n.layerMix||0)>.001){for(;i.length<25;)i.push(0);i.push(n.field2||0,n.blend||0,Math.round(n.layerMix*100))}if((n.material||0)>0){for(;i.length<28;)i.push(0);i.push(Math.round(n.material))}let s=n.pal===8?24:12;for(;i.length>s&&i[i.length-1]===0;)i.pop();return e+"#p="+i.join(",")}toDataURL(e="image/png",t){return this._resize(),this._render(),this.canvas.toDataURL(e,t)}destroy(){this._destroyed=!0,this._stopLoop(),this._ro&&this._ro.disconnect(),this._io&&this._io.disconnect(),this.doc.removeEventListener("visibilitychange",this._onVis),this.canvas.removeEventListener("webglcontextlost",this._onLost),this.canvas.removeEventListener("webglcontextrestored",this._onRestored);let e=this.gl&&this.gl.getExtension("WEBGL_lose_context");if(e)try{e.loseContext()}catch{}this.canvas.parentNode&&this.canvas.parentNode.removeChild(this.canvas)}_applyParams(e){let t=this.state;if(e.look!=null){let n=M.find(i=>i.label.toLowerCase()===String(e.look).toLowerCase());if(!n)throw new Error('fluid-core: unknown look "'+e.look+'"');let o=n.p;t.speed=o[0],t.zoom=o[1],t.warp=o[2],t.grain=o[3],t.pixel=o[4],t.dot=o[5],t.dots=o[6],t.pal=o[7],t.seed=o[8],t.field=n.field||0,t.screen=n.screen||0,t.material=n.material||0,t.thresh=n.thresh!=null?n.thresh:.5,n.cols&&(t.pal=8,t.cols=n.cols.map(S))}if(e.field!=null){let n=d(h,e.field);if(n<0)throw new Error('fluid-core: unknown field "'+e.field+'" \u2014 valid: '+h.join(", "));t.field=n}if(e.layer!=null)if(e.layer===!1||e.layer.mix===0)t.field2=0,t.blend=0,t.layerMix=0;else{let n=d(h,e.layer.field!=null?e.layer.field:0),o=d(E,e.layer.blend!=null?e.layer.blend:"screen");if(n<0)throw new Error("fluid-core: unknown layer.field");if(o<0)throw new Error("fluid-core: unknown layer.blend \u2014 valid: "+E.join(", "));t.field2=n,t.blend=o,t.layerMix=e.layer.mix!=null?Math.max(0,Math.min(1,e.layer.mix)):.5}if(e.colors!=null){if(!Array.isArray(e.colors)||e.colors.length!==4)throw new Error("fluid-core: colors must be 4 hex stops, dark -> light");t.pal=8,t.cols=e.colors.map(S)}else if(e.palette!=null){let n=d(x,e.palette);if(n<0)throw new Error('fluid-core: unknown palette "'+e.palette+'" \u2014 valid: '+x.join(", "));t.pal=n}if(e.screen!=null){let n=e.screen==="none"?0:d(y,e.screen);if(n<0)throw new Error("fluid-core: unknown screen \u2014 valid: "+y.join(", "));t.screen=n,e.pixel==null&&e.look==null&&n>0&&t.pixel<=1.5&&(t.pixel=6)}if(e.material!=null){let n=d(w,e.material);if(n<0)throw new Error("fluid-core: unknown material \u2014 valid: "+w.join(", "));t.material=n}for(let n of["speed","zoom","warp","grain","pixel","dot","dots","thresh","sym","seed"])e[n]!=null&&(t[n]=+e[n])}_initGL(){let e=this.canvas.getContext("webgl",{preserveDrawingBuffer:!0})||this.canvas.getContext("experimental-webgl",{preserveDrawingBuffer:!0});if(!e)throw new Error("fluid-core: WebGL is not available");this.gl=e,e.getExtension("OES_standard_derivatives");let t=(l,c)=>{let u=e.createShader(l);if(e.shaderSource(u,c),e.compileShader(u),!e.getShaderParameter(u,e.COMPILE_STATUS))throw new Error("fluid-core shader: "+e.getShaderInfoLog(u));return u},n=e.createProgram();e.attachShader(n,t(e.VERTEX_SHADER,k)),e.attachShader(n,t(e.FRAGMENT_SHADER,R)),e.linkProgram(n),e.useProgram(n);let o=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,o),e.bufferData(e.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),e.STATIC_DRAW);let i=e.getAttribLocation(n,"a_pos");e.enableVertexAttribArray(i),e.vertexAttribPointer(i,2,e.FLOAT,!1,0,0),this.U={},["u_res","u_time","u_seed","u_scale","u_warp","u_sym","u_pixel","u_dots","u_dot","u_dither","u_grain","u_pal","u_c0","u_c1","u_c2","u_c3","u_tex","u_hasTex","u_texAspect","u_liq","u_mix","u_split","u_field","u_field2","u_blend","u_layerMix","u_screen","u_material","u_glyph","u_pan","u_mouse","u_mouseAmt","u_mouseMode","u_rec","u_mask","u_hasMask","u_maskBg","u_maskBg2","u_maskGrad"].forEach(l=>{this.U[l]=e.getUniformLocation(n,l)});let r=l=>{e.activeTexture(e.TEXTURE0+l);let c=e.createTexture();return e.bindTexture(e.TEXTURE_2D,c),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,new Uint8Array([0,0,0,255])),c};r(0),e.uniform1i(this.U.u_tex,0),e.activeTexture(e.TEXTURE1);let s=e.createTexture();e.bindTexture(e.TEXTURE_2D,s),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,P(this.doc)),e.uniform1i(this.U.u_glyph,1),r(2),e.uniform1i(this.U.u_mask,2),e.activeTexture(e.TEXTURE0)}_resize(){let e=this.container.clientWidth||1,t=this.container.clientHeight||1,n=Math.min((typeof devicePixelRatio=="number"?devicePixelRatio:1)||1,2);e*t*n*n>F&&(n=Math.max(1,Math.sqrt(F/(e*t))));let o=Math.max(1,Math.round(e*n)),i=Math.max(1,Math.round(t*n));(this.canvas.width!==o||this.canvas.height!==i)&&(this.canvas.width=o,this.canvas.height=i)}_render(){let e=this.gl,t=this.U,n=this.state;if(!e||e.isContextLost())return;let o=this.canvas.clientWidth>0?this.canvas.width/this.canvas.clientWidth:1;e.viewport(0,0,this.canvas.width,this.canvas.height),e.uniform2f(t.u_res,this.canvas.width,this.canvas.height),e.uniform1f(t.u_time,this.t),e.uniform1f(t.u_seed,n.seed),e.uniform1f(t.u_scale,n.zoom),e.uniform1f(t.u_warp,n.warp),e.uniform1f(t.u_sym,n.sym),e.uniform1f(t.u_pixel,n.pixel<=1.5?1:n.pixel*o),e.uniform1f(t.u_dots,n.dots),e.uniform1f(t.u_dot,n.dot*o),e.uniform1f(t.u_dither,n.thresh),e.uniform1f(t.u_grain,n.grain),e.uniform1i(t.u_pal,n.pal);let i=n.pal===8&&n.cols?n.cols:m[n.pal]||m[0];e.uniform3f(t.u_c0,i[0][0],i[0][1],i[0][2]),e.uniform3f(t.u_c1,i[1][0],i[1][1],i[1][2]),e.uniform3f(t.u_c2,i[2][0],i[2][1],i[2][2]),e.uniform3f(t.u_c3,i[3][0],i[3][1],i[3][2]),e.uniform1f(t.u_hasTex,0),e.uniform1f(t.u_texAspect,1),e.uniform1f(t.u_liq,.8),e.uniform1f(t.u_mix,.85),e.uniform1f(t.u_split,0),e.uniform1i(t.u_field,n.field),e.uniform1i(t.u_field2,n.field2||0),e.uniform1i(t.u_blend,n.blend||0),e.uniform1f(t.u_layerMix,n.layerMix||0),e.uniform1i(t.u_screen,n.screen),e.uniform1i(t.u_material,n.material||0),e.uniform2f(t.u_pan,0,0),e.uniform2f(t.u_mouse,.5,.5),e.uniform1f(t.u_mouseAmt,0),e.uniform1i(t.u_mouseMode,1),e.uniform1f(t.u_rec,0),e.uniform1f(t.u_hasMask,0),e.uniform3f(t.u_maskBg,.05,.05,.06),e.uniform3f(t.u_maskBg2,.16,.16,.27),e.uniform1f(t.u_maskGrad,0),e.drawArrays(e.TRIANGLES,0,3)}_shouldAnimate(){return!this._destroyed&&this._playing&&this.state.speed!==0&&this._visible&&this.doc.visibilityState!=="hidden"}_kick(){if(!this._destroyed)if(this._shouldAnimate()){if(this._raf==null){this._last=0;let e=t=>{if(this._raf=null,!this._shouldAnimate()){this._needsPaint&&this._paintOnce();return}let n=this._last?Math.min((t-this._last)/1e3,.1):0;this._last=t,this.t+=n*this.state.speed,this._resize(),this._render(),this._needsPaint=!1,this._raf=requestAnimationFrame(e)};this._raf=requestAnimationFrame(e)}}else this._needsPaint&&this._paintOnce()}_paintOnce(){this._destroyed||(this._resize(),this._render(),this._needsPaint=!1)}_stopLoop(){this._raf!=null&&(cancelAnimationFrame(this._raf),this._raf=null)}};function T(a,e){return new _(a,e)}function v(a){return a=Math.max(0,Math.round(a)),[Math.floor(a/65536)%256/255,Math.floor(a/256)%256/255,a%256/255]}function G(a){let e=t=>{let n=Math.max(0,Math.min(255,Math.round(t*255))).toString(16);return n.length<2?"0"+n:n};return"#"+e(a[0])+e(a[1])+e(a[2])}var f=(a,e,t)=>Math.min(t,Math.max(e,Math.round(a)));function b(a){let e=String(a||""),t=e.indexOf("#p=");t>=0?e=e.slice(t+3):e.indexOf("p=")===0?e=e.slice(2):e.charAt(0)==="#"&&(e=e.slice(1));let n=e.split(",").map(parseFloat);if(n.length<12||n.some(isNaN))return null;let o={speed:n[0],zoom:n[1],warp:n[2],grain:n[3],pixel:Math.round(n[4]),dot:Math.round(n[5]),dots:Math.round(n[6])?1:0,seed:n[8],ar:n[11]>=.3&&n[11]<=3?n[11]:1,field:n.length>14?f(n[14],0,14):0,screen:n.length>15?f(n[15],0,4):0,sym:n.length>18?f(n[18],0,12):0,thresh:n.length>24?Math.max(0,Math.min(1,.5+n[24])):.5,material:n.length>28?f(n[28],0,5):0},i=f(n[7],0,8);if(i===8){let s=n.length>23?[v(n[20]),v(n[21]),v(n[22]),v(n[23])]:m[0];o.colors=s.map(G)}else o.palette=i;let r=n.length>27?Math.max(0,Math.min(1,n[27]/100)):0;return r>.001&&(o.layer={field:n.length>25?f(n[25],0,14):0,blend:n.length>26?f(n[26],0,5):0,mix:r}),o}var I="https://fluid.krackeddevs.com",L="#p=0.5,1.5,5.5,0.03,1,10,0,0,18,0,0,1.7778,0,1,1",D=13;function q(a){let e=a||L;e.charAt(0)==="#"&&(e=e.slice(1)),e.indexOf("p=")===0&&(e=e.slice(2)),/^[0-9.,\-]*$/.test(e)||(e=L.replace(/^#p=/,""));let t=e.split(",");for(;t.length<=D;)t.push("0");return t[D]="1","#p="+t.join(",")}function z(a={}){let e=(a.base||I).replace(/\/+$/,"");return/^https?:\/\//i.test(e)||(e=I.replace(/\/+$/,"")),e+"/"+q(a.hash)}function C(a){if(!a)return!1;let e=getComputedStyle(a).backgroundColor;if(!e||e==="transparent")return!1;let t=e.match(/^rgba?\(([^)]+)\)/i);if(!t)return!0;let n=t[1].split(",");return(n.length>=4?parseFloat(n[3]):1)>0}var B=!1;function A(a){B||typeof document=="undefined"||typeof getComputedStyle=="undefined"||a>=0||(C(document.body)||C(document.documentElement))&&(B=!0,console.warn("[fluid-bg] A `fixed` background sits at z-index "+a+", but the page background (on <body>/<html>) is opaque and paints over it, so you'll see nothing (often a black screen). Make the page background transparent \u2014 e.g. `html, body { background: transparent }` \u2014 or raise the z-index above your page background. See https://github.com/enonforetsam/fluid/tree/master/fluid-bg#using-fixed-keep-the-page-background-transparent"))}function H(a){let e=document.createElement("iframe");return e.src=a,e.title="Fluid background",e.loading="lazy",e.setAttribute("aria-hidden","true"),e.setAttribute("tabindex","-1"),e.style.cssText="border:0;display:block;width:100%;height:100%;pointer-events:none;",e}function X(a,e){let t=b(q(e))||b(L);return T(a,t)}function O(a,e){if(e.mode!=="iframe")try{let n=X(a,e.hash);return{mode:"native",cleanup:()=>n.destroy(),mount:n}}catch{}let t=H(z(e));return a.appendChild(t),{mode:"iframe",cleanup:()=>t.remove()}}function U(a,e={}){if(e.fixed){let i=e.z==null||isNaN(Number(e.z))?-1:Number(e.z);A(i);let r=document.createElement("div");r.style.cssText="position:fixed;inset:0;overflow:hidden;pointer-events:none;z-index:"+i+";",(a||document.body).appendChild(r);let s=O(r,e);return{el:r,mode:s.mode,destroy:()=>{s.cleanup(),r.remove()},pause:s.mount?()=>{s.mount.pause()}:void 0,play:s.mount?()=>{s.mount.play()}:void 0}}let t=a||document.body;getComputedStyle(t).position==="static"&&(t.style.position="relative");let n=document.createElement("div");n.style.cssText="position:absolute;inset:0;width:100%;height:100%;overflow:hidden;pointer-events:none;",t.appendChild(n);let o=O(n,e);return{el:t,mode:o.mode,destroy:()=>{o.cleanup(),n.remove()},pause:o.mount?()=>{o.mount.pause()}:void 0,play:o.mount?()=>{o.mount.play()}:void 0}}import{jsx as V}from"react/jsx-runtime";function W({hash:a,fixed:e,z:t,base:n,mode:o,className:i,style:r}){let s=p.useRef(null);p.useEffect(()=>{e&&A(t!=null?t:-1)},[e,t]),p.useEffect(()=>{if(!s.current)return;let c=U(s.current,{hash:a,base:n,mode:o});return()=>c.destroy()},[a,n,o]);let l=e?{position:"fixed",inset:0,width:"100vw",height:"100vh",pointerEvents:"none",overflow:"hidden",zIndex:t!=null?t:-1}:{position:"relative",width:"100%",height:"100%"};return V("div",{ref:s,className:i,style:{...l,...r},"aria-hidden":"true"})}var re=W;export{W as FluidBg,re as default};
